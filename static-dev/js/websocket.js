draftSocket.onmessage = function (e) {
  ...
  if (msgType == "championselect") {
    ...
    draft.draft.temp = no;
    document.querySelector(".od_" + order + " .sp").style.backgroundImage =
      "url(/assets/img/genshin_all.png)";
    document.querySelector(".od_" + order + " .sp").style.backgroundPosition =
      "0px -" + String(Number(no) * 81) + "px";
  }
};
